...
4. 使用 LSS 持久化时，阅读 [LSS Node-ID 与 bitrate 持久化](lss-persistence.md)。
5. 替换 demo OD 前，阅读 [Object Dictionary 指南](object-dictionary.md)。
6. 更新 CANopenNode 前，阅读[子模块更新说明](submodule-update.md)。
7. 遇到构建或运行异常时，参考[故障排查](troubleshooting.md)。
