/**
 * @file CO_401_analog.h
 * @brief Stage-1 analogue process-image helpers for the CiA 401 Device core.
 */

#ifndef CO_401_ANALOG_H
#define CO_401_ANALOG_H
...
/**
 * @brief Refresh enabled 0x6401 channels; an unbound or incomplete runtime is a no-op.
 *
...
/**
 * @brief Apply enabled 0x6411 command channels; an unbound or incomplete runtime is a no-op.
 *
 * Direct callers must use the same serialization contract as
 * CO_401_device_process(): serialize against concurrent SDO/PDO access to the
 * mapped OD entries, and do not recursively acquire that serialization from an
